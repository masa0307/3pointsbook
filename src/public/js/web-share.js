...
if (typeof navigator.share === "undefined") {
  ...
  shareButtons.forEach(function (shareButton) {
    shareButton.addEventListener("click", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        var shareData, _shareData, _shareData2;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                shareData = {
                  text: "\n                            \u3010".concat(e.target.parentNode.parentNode.firstElementChild.textContent, "\u3011\n                                \uFF08").concat(e.target.previousElementSibling.previousElementSibling.textContent, "\u30E1\u30E2\uFF09\n                                \u30FB").concat(e.target.nextElementSibling.value, "\n                        ").replace(/^\n|\s+$|^ {28}/gm, "")
                };
                _context.next = 5;
              ...
              case 7:
                if (!location.href.match(/action-list/)) {
                  _context.next = 13;
                  break;
                }
              ...
              case 13:
                if (!location.href.match(/feedback-list/)) {
                  _context.next = 17;
                  break;
                }
